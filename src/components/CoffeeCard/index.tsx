...
export function CoffeeCard({
  ...
  return (
    <div className="flex w-[16rem] flex-col items-center rounded-tl rounded-bl-[36px] rounded-tr-[36px] rounded-br h-[19.375rem] bg-[#F3F2F2] dark:bg-zinc-800 shadow-2xl">
